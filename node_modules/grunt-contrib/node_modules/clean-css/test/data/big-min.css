...
.fb13x13, .tw13x13, .google13x13, .linkedin13x13, .fb13x13_gris, .tw13x13_gris, .fb13x13_blanc, .tw13x13_blanc, .google13x13_blanc, .linkedin13x13_blanc, .tw_bird, .nb_reactions .pic, .nb_commentaires .pic, .lien_externe span, .bt_ouvrir, .bt_ouvrir:hover, .bt_fermer, .ico_annee_en_france, .croix_blanche, .croix_grise, .nl_blanc {
...
.toute-l-actualite h2, .toute-l-actualite h3 {
    display: inline;
    font-size: 11px;
    font-weight: 400
}
...
*+html #surheader>a, #surheader .bt_abo {
    display: block;
    float: right;
    padding: 0 16px;
    color: #000
...
.sociaux .obf, .sociaux .obf strong, .sociaux .obf span, .sociaux .obf:hover strong, .sociaux .obf:hover span, .sociaux .obf:focus strong, .sociaux .obf:focus span {
    color: #000;
    text-decoration: none
}
...
.conteneur_lives .live .bandeau .voir, .conteneur_lives .lives .chrome .live_replier, .conteneur_lives .lives .chrome .popup, .conteneur_lives .lives .chrome .live_deplier, .conteneur_lives .lives .chrome .live_fermer {
...
.conteneur_lives .lives.grand .chrome .live_replier, .conteneur_lives .lives.grand .chrome .popup, .conteneur_lives .lives.grand .chrome .live_deplier, .conteneur_lives .lives.grand .chrome .live_fermer {
    opacity: .6
}

.conteneur_lives .lives.grand .chrome .live_replier:hover, .conteneur_lives .lives.grand .chrome .popup:hover, .conteneur_lives .lives.grand .chrome .live_deplier:hover, .conteneur_lives .lives.grand .chrome .live_fermer:hover {
    opacity: 1
}
...
body.access-pre .block-ad, body.access-ess .block-ad {
    display: none !important
}
...
#header-liberation .header-base .home, #header-liberation .header-base .sites-info-search, #header-liberation .header-base .links, #header-liberation .header-base .digitalpaper {
    display: block;
    float: left
}
...
.block.rounded, .block .block-content.rounded {
    border-radius: 5px;
    -moz-border-radius: 5px;
    -webkit-border-radius: 5px
}
...
#core-liberation .block-basic-curled .shadow-left, #core-liberation .block-basic-curled .shadow-right, #core-liberation .block-basic-curled .shadow-top-left, #core-liberation .block-basic-curled .shadow-top-right {
    display: block;
    position: absolute;
    z-index: 0;
    width: 35%;
...
#core-liberation .block-basic-curled .shadow-left, #core-liberation .block-basic-curled .shadow-right {
    bottom: -4px
}

#core-liberation .block-basic-curled .shadow-top-left, #core-liberation .block-basic-curled .shadow-top-right {
    top: -4px
}

#core-liberation .block-basic-curled .shadow-left, #core-liberation .block-basic-curled .shadow-top-left {
    left: -4px
}

#core-liberation .block-basic-curled .shadow-right, #core-liberation .block-basic-curled .shadow-top-right {
    right: -4px
}

#core-liberation .block-basic-curled .block-top, #core-liberation .block-basic-curled .block-content {
    position: relative;
    z-index: 1000;
    background: #fff
}
...
#core-liberation .cartridge-basic-bubble .plain, #core-liberation .cartridge-basic-bubble .segment {
    display: block;
    float: left;
    border: 1px solid #222;
    border-radius: 5px;
...
#core-liberation .pagination .disabled, #core-liberation .pagination .current {
    background: #7d7d7d;
    color: #fff
}
...
#core-liberation, #header-liberation, #footer-liberation {
    display: block;
    clear: both;
    margin: 0 0 14px 0
}
...
.w35unit, .w35unit .visual100 {
    width: 980px
}

.w34unit, .w34unit .visual100 {
    width: 952px
}

.w33unit, .w33unit .visual100 {
    width: 924px
}

.w32unit, .w32unit .visual100 {
    width: 896px
}

.w31unit, .w31unit .visual100 {
    width: 868px
}

.w30unit, .w30unit .visual100 {
    width: 840px
}

.w29unit, .w29unit .visual100 {
    width: 812px
}

.w28unit, .w28unit .visual100 {
    width: 784px
}

.w27unit, .w27unit .visual100 {
    width: 756px
}

.w26unit, .w26unit .visual100 {
    width: 728px
}

.w25unit, .w25unit .visual100 {
    width: 700px
}

.w24unit, .w24unit .visual100 {
    width: 672px
}

.w23unit, .w23unit .visual100 {
    width: 644px
}

.w22unit, .w22unit .visual100 {
    width: 616px
}

.w21unit, .w21unit .visual100 {
    width: 588px
}

.w20unit, .w20unit .visual100 {
    width: 560px
}

.w19unit, .w19unit .visual100 {
    width: 532px
}

.w18unit, .w18unit .visual100 {
    width: 504px
}

.w17unit, .w17unit .visual100 {
    width: 476px
}

.w16unit, .w16unit .visual100 {
    width: 448px
}

.w15unit, .w15unit .visual100 {
    width: 420px
}

.w14unit, .w14unit .visual100 {
    width: 392px
}

.w13unit, .w13unit .visual100 {
    width: 364px
}

.w12unit, .w12unit .visual100 {
    width: 336px
}

.w11unit, .w11unit .visual100 {
    width: 308px
}

.w10unit, .w10unit .visual100 {
    width: 280px
}

.w9unit, .w9unit .visual100 {
    width: 252px
}

.w8unit, .w8unit .visual100 {
    width: 224px
}

.w7unit, .w7unit .visual100 {
    width: 196px
}

.w6unit, .w6unit .visual100 {
    width: 168px
}

.w5unit, .w5unit .visual100 {
    width: 140px
}

.w4unit, .w4unit .visual100 {
    width: 112px
}

.w3unit, .w3unit .visual100 {
    width: 84px
}

.w2unit, .w2unit .visual100 {
    width: 56px
}

.w1unit, .w1unit .visual100 {
    width: 28px
}
...
ul.list li:first-child, ul.list li.new-line {
    clear: both;
    margin-left: 0
}
...
.site-liberation #header-liberation h2, .site-liberation #header-liberation h1 {
    font-family: Verdana, Arial, Helvetica, sans-serif
}
...
#header-liberation .header-base .links .lnk1, #header-liberation .header-base .links .lnk2 {
    float: left
}
...
#header-liberation .header-base .digitalpaper a.dl, #header-liberation .header-base .digitalpaper a.abo {
    display: block;
    position: absolute;
    top: 15px;
    right: 0;
...
#header-liberation .header-base .nav .nav1 .on a span, #header-liberation .header-base .nav-no-js>li:hover .nav1 a span, #header-liberation .header-base .nav .nav1 a:hover span {
    width: 9px;
    height: 9px
}
...
#header-liberation .header-annex h1, #header-liberation .header-annex ul {
    display: block;
    margin-left: 230px
}
...
.site-liberation #footer-liberation h2, .site-liberation #footer-liberation h3 {
    font-family: Verdana, Arial, Helvetica, sans-serif
}
...
#footer-liberation .abo, #footer-liberation .monlibe, #footer-liberation .news, #footer-liberation .services {
    display: block;
    float: left
}
...
#footer-liberation .monlibe, #footer-liberation .news, #footer-liberation .services {
    min-height: 200px
}
...
#footer-liberation .monlibe h5, #footer-liberation .news h5, #footer-liberation .services h5 {
    text-transform: uppercase;
    padding: 0 0 4px 0;
    font-size: 10px
}
...
#footer-liberation .news h5, #footer-liberation .services h5 {
    margin-bottom: 10px
}

#footer-liberation .news ul, #footer-liberation .services ul {
    border-right: 1px dotted;
    font-size: 10px;
    width: 83px;
    float: left;
...
#footer-liberation .news ul:last-of-type, #footer-liberation .services ul:last-of-type {
    border-right: 0;
    width: 84px
}

#footer-liberation .news ul li, #footer-liberation .services ul li {
    padding: 0 14px 0 0;
    margin-bottom: 7px;
    line-height: 10px
}

#footer-liberation .news ul:last-of-type li, #footer-liberation .services ul:last-of-type li {
    padding: 0 0 0 14px
}
...
#core-liberation .text h2, #core-liberation .text h3 {
    margin-bottom: 14px
}

#core-liberation .text sub, #core-liberation .text sup {
    line-height: 10px
}

#core-liberation .text-static h2, #core-liberation .text-static h3, #core-liberation .text-static h4 {
...
#core-liberation .text-https h2, #core-liberation .text-https h3, #core-liberation .text-https h4 {
    font-family: Verdana, sans-serif;
    font-weight: 400
}
...
#core-liberation form input[type=text]:focus, #core-liberation form input[type=password]:focus, #core-liberation form input[type=file]:focus, #core-liberation form textarea:focus, #core-liberation form select, #core-liberation form checkbox {
    outline: 1px solid
}

#core-liberation .error_ajax, #core-liberation .error_ajax_form {
    background: #ddd;
...
#core-liberation .form-monlibe input[type=text], #core-liberation .form-monlibe input[type=password], #core-liberation .form-monlibe textarea {
    border: 1px solid;
    font-size: 12px;
    margin-bottom: 20px;
    padding: 3px
...
#core-liberation .w26unit .form-monlibe input[type=text], #core-liberation .w26unit .form-monlibe input[type=password], #core-liberation .w26unit .form-monlibe textarea {
    width: 652px
}

#core-liberation .w17unit .form-monlibe input[type=text], #core-liberation .w17unit .form-monlibe input[type=password], #core-liberation .w17unit .form-monlibe textarea {
    width: 412px
}
...
#core-liberation .block-comments .form-monlibe input[type=text], #core-liberation .block-comments .form-monlibe textarea {
    width: 98%
}
...
#core-liberation .form-https p input[type=text], #core-liberation .form-https p input[type=password] {
    display: block;
    width: 372px;
    border-radius: 2px;
...
#core-liberation .form-https .btn-rounded-degraded, #core-liberation .form-https .btn-laune {
    margin-top: 7px;
    float: right
}
...
#core-liberation ul.list-items li h5, #core-liberation ul.list-items li h4, #core-liberation ul.list-items li p {
    margin-left: 98px
}
...
#core-liberation ul.list-items li img.square, #core-liberation ul.list-items li img.signature {
    width: 84px;
    height: 84px
}

#core-liberation ul.list-items li.full h5, #core-liberation ul.list-items li.full h4, #core-liberation ul.list-items li.full p {
    margin-left: 0
}
...
#core-liberation ul.list-items li.full h5, #core-liberation ul.list-items li.half h4, #core-liberation ul.list-items li.half p {
    margin-left: 140px
}
...
#core-liberation ul.list-items li.arround h5, #core-liberation ul.list-items li.arround h4, #core-liberation ul.list-items li.arround p {
    margin-left: 0
}
...
#core-liberation ul.list-labo-meetings li:last-child img, #core-liberation ul.list-labo-meetings li:last-child p {
    margin-bottom: 0;
    padding-bottom: 0
}
...
.col-contextual>div:first-child, .col-contextual>.first {
    margin-top: 0;
    margin-bottom: 0
}

.col-contextual>.div:last-child, .col-contextual>.block:last-child {
    margin-bottom: 28px
}
...
.col-contextual .ad-square, .col-contextual .block-ad {
    display: block;
    margin: 14px auto;
    width: 300px
}
...
.col-part .block .follow-libe .fb, .col-part .block .follow-libe .twitter, .col-part .block .follow-libe .nv-rss {
    padding-top: 7px
}

.col-part .block .follow-libe .fb p, .col-part .block .follow-libe .twitter p, .col-part .block .follow-libe .nv-rss p {
    font-size: 10px
}
...
.col-part .block .follow-libe .nv-rss a.nv, .col-part .block .follow-libe .nv-rss a.rss {
    display: inline-block;
    height: 18px;
...
#core-liberation .block-item-locked h2, #core-liberation .block-item-locked h3, #core-liberation .block-item-locked p {
    margin-left: 270px
}
...
#core-liberation .flat-comments .comment, #core-liberation .block-comments .comment_level_0 {
    margin-top: 20px;
    border-top: 1px solid
}

#core-liberation .flat-comments .comment:first-of-type, #core-liberation .block-comments .comment_level_0:first-of-type {
    margin-top: 0
}

#core-liberation .flat-comments .comment>.comment_outer, #core-liberation .block-comments .comment_level_0>.comment_outer {
    margin-left: -1px;
    border: 1px solid;
    border-top: 0
}
...
#core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .who, #core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .details, #core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .note {
    padding-right: 35px
}
...
#core-liberation .block-comments .block-content .comment_collapsed>.comment_content>*, #core-liberation .block-comments .block-content .comment_collapsed>.visual {
    display: none
}

#core-liberation .block-comments .block-content .comment_expanded>.comment_content>*, #core-liberation .block-comments .block-content .comment_expanded>.visual {
    display: block
}
...
#core-liberation .block-comments .block-content .meta .who, #core-liberation .block-comments .block-content .meta .details, #core-liberation .block-comments .block-content .meta .note, #core-liberation .block-comments .block-content .meta .when {
    display: block
}

#core-liberation .block-comments .block-content .meta .details, #core-liberation .block-comments .block-content .meta .note {
    font-size: 10px
}
...
#core-liberation .block-comments .block-content .comment_reply_links .comment_flag, #core-liberation .block-comments .block-content .comment_reply_links .comment_post_new {
    display: none;
    float: right;
    margin-right: 10px;
    padding-top: 5px
...
#core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .who, #core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .details, #core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .note {
    padding-right: 41px
}
...
#core-liberation .block-comments .headrest-community a.folded:after, #core-liberation .block-comments .headrest-community a.unfolded:after {
    display: inline-block;
    content: '';
    background-image: url('http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49');
    background-repeat: no-repeat
...
.comment_god_actions ul, .comment_god_actions li, .comment_god_actions form {
    display: inline-block
}
...
#core-liberation .block-partnership .block-content ul li a, #core-liberation .block-partnership .block-content a.arrow {
...
#core-liberation .block-pager-labo .block-top, #core-liberation .block-pager-labo .block-content {
    margin-bottom: 14px
}
...
#core-liberation .col .block-pager-labo .list li:first-child, #core-liberation .col .block-pager-labo .list li.new-line {
    margin-left: 0
}
...
#core-liberation .block-benefits .block-content .text-benefits li h5, #core-liberation .block-benefits .block-content .text-benefits li h3, #core-liberation .block-benefits .block-content .text-benefits li p {
    margin-left: 126px
}
...
.w11unit .block-np .from .btn-read-digitalpaper a, .w11unit .block-np .from .btn-read-digitalpaper span {
    display: table-cell;
    vertical-align: middle;
    width: 214px;
    height: 32px
...
#core-liberation .col-contextual .block-promo .block-content ul li a, #core-liberation .col-contextual .block-promo .block-content a.arrow {
    background: url('http://s0.libe.com/libe/img/common/ico-lnk-arrow-red.gif?feba6ff926a7') no-repeat 0 4px;
    padding-left: 15px
}
...
#core-liberation .block-all-forums .block-top, #core-liberation .block-all-forums .block-content .forums-most {
    margin-bottom: 28px
}
...
#core-liberation .block-all-forums table th, #core-liberation .block-all-forums table td {
    padding: 4px 0 6px
}
...
#core-liberation .block-search-head form input[type=submit], #core-liberation .block-search-results form input[type=submit] {
...
#core-liberation .block-search-head .pagination a, #core-liberation .block-search-results .pagination a {
    background-color: #fff
}

#core-liberation .block-search-head .pagination .prev, #core-liberation .block-search-results .pagination .prev {
    margin-left: 0;
    padding-left: 17px
}

#core-liberation .block-search-head .pagination .next, #core-liberation .block-search-results .pagination .next {
    margin-right: 0;
    padding-right: 17px
}
...
#core-liberation .block-search-head .advanced .searchform .period, #core-liberation .block-search-head .advanced .searchform .between, #core-liberation .block-search-head .advanced .searchform .source, #core-liberation .block-search-head .advanced .searchform .category {
...
#core-liberation .block-search-head .advanced .searchform .between .from, #core-liberation .block-search-head .advanced .searchform .between .to {
    display: inline;
    padding-left: 5px
}
...
#core-liberation .block-search-head .advanced .searchform .source ul, #core-liberation .block-search-head .advanced .searchform .source ul li {
    display: inline
}
...
#core-liberation .block-search-results .tpl-search-results .folder .object-content, #core-liberation .block-search-results .tpl-search-results .emission .object-content {
    min-height: 53px
}
...
#core-liberation .block-search-results .block-content .article .object-picture, #core-liberation .block-search-results .block-content .article .object-picture img {
    height: 116px
}
...
#core-liberation .block-search-results .block-content .object-picture .np .p1, #core-liberation .block-search-results .block-content .object-picture .np .p2 {
    position: absolute;
    width: 79px;
    height: 102px;
    border-style: solid;
...
#core-liberation .headrest h5, #core-liberation .headrest h4, #core-liberation .headrest h3 {
    font-family: Verdana, sans-serif
}
...
#core-liberation .block .block-top .headrest-basic-striked h5, #core-liberation .headrest-basic-striked h5 {
    border: 0;
    padding: 0 0 4px 0;
    font-weight: 400;
    font-size: 14px;
...
#core-liberation .cartridge .btn-comment, #core-liberation .cartridge .btn-back {
    text-align: center
}

#core-liberation .cartridge .btn-comment span, #core-liberation .cartridge .btn-back span {
    display: block;
    padding: 6px 7px 0;
    font-weight: 700
}

#core-liberation .cartridge a.btn-comment:hover, #core-liberation .cartridge a.btn-back:hover {
    text-decoration: none
}
...
#core-liberation .cartridge-basic-bubble .segment, #core-liberation .cartridge-basic-bubble .plain {
    height: 28px;
    border: 1px solid;
    margin-right: 20px
}
...
#core-liberation .w23unit .cartridge-basic-bubble .text, #core-liberation .w17unit .cartridge-basic-bubble .text {
    margin-right: 0
}
...
form .btn-basic input[type=button], form .btn-basic input[type=submit], form .btn-basic input[type=reset] {
    border: 1px solid;
    padding: 0 10px 4px;
    height: 26px;
    cursor: pointer;
...
.btn-laune span, .btn-laune a, .btn-monlibe span, .btn-monlibe a, .btn-zoneabo span, .btn-zoneabo a {
    display: block;
    padding: 5px 5px 7px;
    border-radius: 5px 5px 5px 5px;
    -moz-border-radius: 5px 5px 5px 5px;
...
.btn-rounded-degraded span, .btn-rounded-degraded a {
    display: block;
    border-radius: 5px 5px 5px 5px;
    -moz-border-radius: 5px 5px 5px 5px;
    -webkit-border-radius: 5px 5px 5px 5px;
...
.btn-rounded-degraded span:hover, .btn-rounded-degraded a:hover {
    text-decoration: none !important
}

form .btn-rounded-degraded input[type=button], form .btn-rounded-degraded input[type=submit] {
    border-radius: 5px 5px 5px 5px;
    -moz-border-radius: 5px 5px 5px 5px;
    -webkit-border-radius: 5px 5px 5px 5px;
    border: 0;
...
form .btn-rounded-degraded input[type=button]:hover, form .btn-rounded-degraded input[type=submit]:hover, form .btn-rounded-degraded input[type=button]:focus, form .btn-rounded-degraded input[type=submit]:focus {
    text-decoration: none
}
...
.btn-read-digitalpaper span, .btn-read-digitalpaper a {
    display: block;
    min-height: 32px;
...
#core-liberation .bg-sprites-icons a.twitter, #core-liberation .bg-sprites-icons a.facebook, #core-liberation .bg-sprites-icons a.mail, #core-liberation .bg-sprites-icons a.star {
    display: block;
    background-image: url('http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49');
    background-repeat: no-repeat
}
...
#core-liberation .bg-sprites-icons .on a.star, #core-liberation .bg-sprites-icons a.star:hover {
    background-position: -23px -36px
}

#core-liberation .bg-sprites-icons .arrow-grey-l, #core-liberation .bg-sprites-icons .arrow-grey-b {
    display: block;
    background-image: url('http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49');
    background-repeat: no-repeat
}
...
#core-liberation .toolbox .txt-min, #core-liberation .toolbox .txt-plus {
    display: block;
    font-size: 15px;
    padding-top: 4px
}
...
.site-liberation .toolbox .txt-min:hover, .site-liberation .toolbox .txt-plus:hover, .site-liberation .toolbox .txt-reset:hover, .site-liberation .toolbox .comment:hover, .site-liberation .toolbox .facebook:hover, .site-liberation .toolbox .twitter {
    text-decoration: none
}
...
.site-liberation .toolbox li a.facebook, .site-liberation .toolbox li a.twitter {
    display: block;
    margin-top: 4px;
    padding: 3px;
    border: 1px solid;
...
#bar-liberation a, #bar-liberation a p {
    text-decoration: none;
    outline: 0
}
...
#bar-liberation .content .close, #bar-liberation .content .open, #bar-liberation .content .login, #bar-liberation .content .personal-options, #bar-liberation .content .mail-box, #bar-liberation .content .activities-stream, #bar-liberation .content .other {
    display: none;
    border-left: 1px solid;
    border-right: 1px solid;
    border-bottom: 1px solid;
...
#bar-liberation .content .activities-stream .list .text, #bar-liberation .content .activities-stream .list p {
    display: inline
}
...
#core-liberation .block-activities .block-content ul li a, #bar-liberation .content ul.list li a, #core-liberation .block-activities .block-content ul li a:hover, #bar-liberation .content ul.list li a:hover {
    text-decoration: underline
}
...
#bar-liberation #login-box-content form input[type=text], #bar-liberation #login-box-content form input[type=password] {
    display: block;
    clear: both;
    width: 175px
}
...
#page-paywall .content .arguments .arg .price strong .currency, #page-paywall .content .arguments .arg .price strong .decimals {
    font-size: 20px
}
...
#page-paywall .content .form-login form p input[type=text], #page-paywall .content .form-login form p input[type=password] {
    border: 1px solid;
    padding: 0 10px 4px;
    width: 160px;
    height: 19px
...
#page-paywall .content .form-login form p input[type=text]:focus, #page-paywall .content .form-login form p input[type=password]:focus {
    border: 1px solid
}
...
.site-liberation h1, .site-liberation h2 {
    font-family: Georgia, "Times New Roman", Times, serif;
    font-size: 26px
}
...
.site-liberation h5 a.theme:hover, .site-liberation a:hover h5 .theme {
    text-decoration: none
}
...
.site-liberation .text-item p.titre, .site-liberation .text-item p.inter {
    margin-bottom: 14px;
    font-family: Georgia, "Times New Roman", Times, serif;
    font-size: 16px;
    font-weight: 700
...
.site-liberation .text-item h5, .site-liberation .text-item .question {
    font-family: Georgia, "Times New Roman", Times, serif;
    font-size: 14px;
    font-weight: 700;
    margin: 21px 0 14px
...
.site-liberation .text-item p span.nickname, .site-liberation .text-item h5 span.nickname {
    font-family: Georgia, "Times New Roman", Times, serif;
    font-size: 14px;
    font-weight: 700;
    color: #999
...
.site-liberation a, .site-liberation a p {
    text-decoration: none;
    outline: 0
}

.site-liberation a:hover, .site-liberation a:hover p, .site-liberation a:hover h6, .site-liberation a:hover h5, .site-liberation a:hover h4, .site-liberation a:hover h3, .site-liberation a:hover h2 {
    text-decoration: underline
}
...
.site-liberation .block-call-items .mini-tpl .lnk-libeplus, .site-liberation .block-call-items .mini-tpl .lnk-libeplus-big {
    background: 0;
    padding: 0
}

.site-liberation .block-call-items .mini-tpl h2.lnk-libeplus:after, .site-liberation .block-call-items .mini-tpl h3.lnk-libeplus:after {
    content: '';
    display: inline-block;
    width: 56px;
    height: 14px;
...
.site-liberation .block-call-items .mini-tpl h5.lnk-libeplus:after, .site-liberation .block-call-items .mini-tpl .list-linked-items a.lnk-libeplus:after {
    content: '';
    display: inline-block;
    width: 56px;
    height: 10px;
...
.site-liberation .block-call-items .mini-tpl h1, .site-liberation .block-call-items .mini-tpl h2 {
    margin-bottom: 14px
}
...
.site-liberation .block-call-items .mini-tpl .item, .site-liberation .block-call-items .mini-tpl .others {
    margin-bottom: 14px
}
...
.site-liberation .w17unit .block-call-items .mini-tpl .others, .site-liberation .w17unit .block-call-items .mini-tpl .others ul.list-linked-items {
    clear: both
}

.site-liberation .w17unit .block-call-items .mini-tpl .big, .site-liberation .w17unit .block-call-items .mini-tpl .pano {
    clear: both;
    margin: 0 0 14px 0
}

.site-liberation .w14unit .block-call-items .mini-tpl .others, .site-liberation .w14unit .block-call-items .mini-tpl .others ul.list-linked-items {
    clear: both
}

.site-liberation .w14unit .block-call-items .mini-tpl .big, .site-liberation .w14unit .block-call-items .mini-tpl .pano {
    clear: both;
    margin: 0 0 14px 0
}
...
.site-liberation .block-call-items .tpl-flash-news-29unit, .site-liberation .block-call-items .tpl-flash-news-29unit:last-of-type {
    border-bottom: 1px dotted #ddd;
    margin: 0 0 14px 0;
    clear: both
}
...
.site-liberation .block-call-items .tpl-breaking-news, .site-liberation .block-call-items .tpl-breaking-news:last-of-type {
    border-bottom: 1px dotted;
    margin: 0 0 15px 0;
    clear: both
}
...
.site-liberation .block-call-items .tpl-search-results .folder-on-demand .object-picture, .site-liberation .block-call-items .tpl-search-results .folder-on-demand .object-picture img.default {
    width: 150px;
    height: 100px
}
...
.site-liberation .block-call-items .tpl-search-results .object-picture .np .p1, .site-liberation .block-call-items .tpl-search-results .object-picture .np .p2 {
    position: absolute;
    background-color: #fff;
    width: 79px;
    height: 102px;
...
.site-liberation .block-call-items .tpl-visual-square-left h5, .site-liberation .block-call-items .tpl-visual-square-left h4, .site-liberation .block-call-items .tpl-visual-square-left h3, .site-liberation .block-call-items .tpl-visual-square-left .subtitle {
    margin-left: 98px
}
...
.site-liberation .block-call-items .tpl-visual-square-left .chat h5, .site-liberation .block-call-items .tpl-visual-square-left .chat .subtitle {
    font-family: Verdana, sans-serif;
    font-size: 12px
}
...
.site-liberation .lnk-readmore a, .site-liberation a.lnk-readmore {
    color: #e20000
}
...
#header-liberation .header-base .nav .on .nav1 a, #header-liberation .header-base .nav-no-js>li:hover .nav1 a, #header-liberation .header-base .nav .nav1 a:hover {
    color: #fff
}

#header-liberation .header-base .nav .on .nav1 a span, #header-liberation .header-base .nav-no-js>li:hover .nav1 a span, #header-liberation .header-base .nav .nav1 a:hover span {
    background-color: #fff
}

#header-liberation .header-base .nav .cat-laune .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-laune:hover .nav1 a, #header-liberation .header-base .nav .cat-laune .nav1 a:hover {
    background-color: #e20000
}

#header-liberation .header-base .nav .cat-labo .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-labo:hover .nav1 a, #header-liberation .header-base .nav .cat-labo .nav1 a:hover {
    background-color: #006a96
}

#header-liberation .header-base .nav .cat-culture .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-culture:hover .nav1 a, #header-liberation .header-base .nav .cat-culture .nav1 a:hover {
    background-color: #e52d83
}

#header-liberation .header-base .nav .cat-rebonds .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-rebonds:hover .nav1 a, #header-liberation .header-base .nav .cat-rebonds .nav1 a:hover {
    background-color: #00b3e2
}

#header-liberation .header-base .nav .cat-ecrans .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-ecrans:hover .nav1 a, #header-liberation .header-base .nav .cat-ecrans .nav1 a:hover {
    background-color: #1d9b9a
}

#header-liberation .header-base .nav .cat-mode .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-mode:hover .nav1 a, #header-liberation .header-base .nav .cat-mode .nav1 a:hover {
    background-color: #944d93
}

#header-liberation .header-base .nav .cat-blogs .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-blogs:hover .nav1 a, #header-liberation .header-base .nav .cat-blogs .nav1 a:hover {
    background-color: #324c99
}

#header-liberation .header-base .nav .cat-voyages .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-voyages:hover .nav1 a, #header-liberation .header-base .nav .cat-voyages .nav1 a:hover {
    background-color: #7baf1f
}

#header-liberation .header-base .nav .cat-regions .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-regions:hover .nav1 a, #header-liberation .header-base .nav .cat-regions .nav1 a:hover {
    background-color: #f2a787
}

#header-liberation .header-base .nav .cat-monlibe .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-monlibe:hover .nav1 a, #header-liberation .header-base .nav .cat-monlibe .nav1 a:hover {
    background-color: #fe9900
}

#header-liberation .header-base .nav .cat-zoneabo .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-zoneabo:hover .nav1 a, #header-liberation .header-base .nav .cat-zoneabo .nav1 a:hover {
    background-color: #a00
}

#header-liberation .header-base .nav .cat-food .nav1 .on a, #header-liberation .header-base .nav-no-js .cat-food:hover .nav1 a, #header-liberation .header-base .nav .cat-food .nav1 a:hover {
    background-color: #000
}
...
#header-liberation .header-base .nav .cat-laune .nav2 a:hover, #header-liberation .header-base .nav .cat-laune .nav2 .on {
    color: #e20000
}

#header-liberation .header-base .nav .cat-labo .nav2 a:hover, #header-liberation .header-base .nav .cat-labo .nav2 .on {
    color: #006a96
}

#header-liberation .header-base .nav .cat-culture .nav2 a:hover, #header-liberation .header-base .nav .cat-culture .nav2 .on {
    color: #e52d83
}

#header-liberation .header-base .nav .cat-rebonds .nav2 a:hover, #header-liberation .header-base .nav .cat-rebonds .nav2 .on {
    color: #00b3e2
}

#header-liberation .header-base .nav .cat-ecrans .nav2 a:hover, #header-liberation .header-base .nav .cat-ecrans .nav2 .on {
    color: #1d9b9a
}

#header-liberation .header-base .nav .cat-mode .nav2 a:hover, #header-liberation .header-base .nav .cat-mode .nav2 .on {
    color: #944d93
}

#header-liberation .header-base .nav .cat-blogs .nav2 a:hover, #header-liberation .header-base .nav .cat-blogs .nav2 .on {
    color: #324c99
}

#header-liberation .header-base .nav .cat-voyages .nav2 a:hover, #header-liberation .header-base .nav .cat-voyages .nav2 .on {
    color: #7baf1f
}

#header-liberation .header-base .nav .cat-regions .nav2 a:hover, #header-liberation .header-base .nav .cat-regions .nav2 .on {
    color: #f2a787
}

#header-liberation .header-base .nav .cat-monlibe .nav2 a:hover, #header-liberation .header-base .nav .cat-monlibe .nav2 .on {
    color: #fe9900
}

#header-liberation .header-base .nav .cat-zoneabo .nav2 a:hover, #header-liberation .header-base .nav .cat-zoneabo .nav2 .on {
    color: #a00
}

#header-liberation .header-base .nav .cat-food .nav2 a:hover, #header-liberation .header-base .nav .cat-food .nav2 .on {
    color: #000
}
...
#footer-liberation .abo, #footer-liberation a {
    color: #818181
}
...
#core-liberation form input[type=text], #core-liberation form input[type=password] {
    border-color: #888
}
...
#core-liberation .error_ajax a, #core-liberation .error_ajax_form a {
    color: #fe9900;
    font-weight: 700
}
...
#core-liberation .form-monlibe-unlogged input[type=button]:hover, #core-liberation .form-monlibe-unlogged input[type=submit]:hover, #core-liberation .form-monlibe-unlogged input[type=reset]:hover {
    background: #878787
}
...
.site-liberation .col-contextual .block .block-top .right, .site-liberation .col-contextual .block .block-top .right a {
    color: #7c8280
}
...
.site-liberation .col-contextual .block-solid-c2 a, .site-liberation .col-contextual .block-solid-c2 a p {
    color: #c6c6c6
}
...
.site-liberation .block-call-items .tpl-flash-news-29col, .site-liberation .block-call-items .tpl-flash-news-29col:last-of-type {
    border-bottom-color: #ddd
}
...
.site-liberation .block-call-items .tpl-search-results h4, .site-liberation .block-call-items .tpl-search-results h4 a {
    color: #959595
}
...
#core-liberation .block-comments .block-content .meta .who, #core-liberation .block-comments .block-content .meta .who a {
    color: #878787
}
...
#core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .note, #core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .note {
    color: #e20000
}
...
#core-liberation .block-comments .block-content .comment_reply_links .comment_reply, #core-liberation .block-comments .block-content .comment_reply_links .comment_reply a {
    color: #fff
}
...
#core-liberation .block-search-head .pagination, #core-liberation .block-search-results .pagination {
    background: 0;
    border-color: #b7b7b7
}

#core-liberation .block-search-head .pagination .disabled, #core-liberation .block-search-results .pagination .disabled {
    color: #c8c8c8
}

#core-liberation .block-search-head .pagination .current, #core-liberation .block-search-results .pagination .current {
    color: #e20000
}

#core-liberation .block-search-head .pagination .disabled, #core-liberation .block-search-results .pagination .disabled, #core-liberation .block-search-head .pagination .current, #core-liberation .block-search-results .pagination .current {
...
#core-liberation .block-search-head .advanced .note .links, #core-liberation .block-search-head .advanced .note .links a {
    color: #87888a
}
...
#core-liberation .block-search-results .block-top h2, #core-liberation .block-search-results .block-top h2 a {
    color: #e20000
}
...
#core-liberation .block-search-results .block-content .category, #core-liberation .block-search-results .block-content .folder, #core-liberation .block-search-results .block-content .emission {
    background-color: #f9f9f9
}

#core-liberation .block-search-results .block-content h4, #core-liberation .block-search-results .block-content h4 a {
    color: #959595
}
...
#core-liberation .headrest-community h3, #core-liberation .headrest-community a.lnk-back, #core-liberation .headrest-community a.lnk-com {
    color: #555
}
...
#core-liberation .cartridge a.btn-comment, #core-liberation .cartridge a.btn-back {
    color: #878787
}
...
#core-liberation .cartridge-basic-rounded p, #core-liberation .cartridge-basic-rounded p a {
    color: #878787
}
...
#core-liberation .cartridge-basic-bubble p, #core-liberation .cartridge-basic-bubble p a {
    color: #878787
}
...
.site-liberation .btn-basic span, .site-liberation .btn-basic a, .site-liberation form .btn-basic input[type=button], .site-liberation form .btn-basic input[type=submit], .site-liberation form .btn-basic input[type=reset] {
    background: #ccc;
...
.site-liberation .btn-laune span, .site-liberation .btn-laune a, .site-liberation .btn-monlibe span, .site-liberation .btn-monlibe a, .site-liberation .btn-zoneabo span, .site-liberation .btn-zoneabo a {
    color: #fff
}

.site-liberation .btn-laune a:hover, .site-liberation .btn-monlibe a:hover, .site-liberation .btn-zoneabo a:hover {
    color: #fff
}
...
.site-liberation .btn-laune span, .site-liberation .btn-laune a {
    background: #e20000
}

.site-liberation form .btn-laune input[type=button], .site-liberation form .btn-laune input[type=submit] {
    background: #e20000 !important
}

.site-liberation form .btn-laune input[type=button]:hover, .site-liberation form .btn-laune input[type=submit]:hover {
    background: #3c3c3c
}

.site-liberation .btn-monlibe span, .site-liberation .btn-monlibe a {
    background: #878787
}

.site-liberation form .btn-monlibe input[type=button], .site-liberation form .btn-monlibe input[type=submit], .site-liberation form .btn-monlibe input[type=reset] {
    background: #878787
}

.site-liberation form .btn-monlibe input[type=button]:hover, .site-liberation form .btn-monlibe input[type=submit]:hover, .site-liberation form .btn-monlibe input[type=reset]:hover {
    background: #3c3c3c
}

.site-liberation .btn-zoneabo span, .site-liberation .btn-zoneabo a {
    background: #a00
}

.site-liberation #core-liberation form .btn-zoneabo input[type=button], .site-liberation #core-liberation form .btn-zoneabo input[type=submit] {
    background: #a00
}

.site-liberation #core-liberation form .btn-zoneabo input[type=button]:hover, .site-liberation #core-liberation form .btn-zoneabo input[type=submit]:hover {
    background: #a00
}

.site-liberation .btn-rounded-degraded span, .site-liberation .btn-rounded-degraded a {
    background: #e20000;
...
.site-liberation .btn-rounded-degraded span:hover, .site-liberation .btn-rounded-degraded a:hover {
    background: #e20000;
...
.site-liberation form .btn-rounded-degraded input[type=button], .site-liberation form .btn-rounded-degraded input[type=submit] {
    background: #e20000;
    background: -moz-linear-gradient(top, #f33333 0, #b33 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #f33333), color-stop(100%, #b33));
    background: -webkit-linear-gradient(top, #f33333 0, #b33 100%);
...
.site-liberation form .btn-rounded-degraded input[type=button]:hover, .site-liberation form .btn-rounded-degraded input[type=submit]:hover, .site-liberation form .btn-rounded-degraded input[type=button]:focus, .site-liberation form .btn-rounded-degraded input[type=submit]:focus {
    background: #e20000;
    background: -moz-linear-gradient(top, #b33 0, #f33333 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #b33), color-stop(100%, #f33333));
    background: -webkit-linear-gradient(top, #b33 0, #f33333 100%);
...
.site-liberation .btn-read-digitalpaper span, .site-liberation .btn-read-digitalpaper a {
    color: #2e2e2e
}
...
.site-liberation .bg-sprites-icons .folder1, .site-liberation .bg-sprites-icons .folder1-black, .site-liberation .bg-sprites-icons .folder1-monlibe {
    width: 19px;
    height: 15px
}
...
.site-liberation .cat-monlibe .bg-sprites-icons .on .folder1, .site-liberation .cat-monlibe .bg-sprites-icons a:hover .folder1 {
    background-position: -131px -84px
}

.site-liberation .bg-sprites-icons .close1, .site-liberation .bg-sprites-icons .close1-black, .site-liberation .bg-sprites-icons .close1-monlibe {
    width: 15px;
    height: 15px
}
...
.site-liberation .cat-monlibe .bg-sprites-icons .on .close1, .site-liberation .cat-monlibe .bg-sprites-icons a:hover .close1 {
    background-position: -76px -99px
}

.site-liberation .bg-sprites-icons .edit1, .site-liberation .bg-sprites-icons .edit1-black, .site-liberation .bg-sprites-icons .edit1-monlibe {
    width: 15px;
    height: 15px
}
...
.site-liberation .cat-monlibe .bg-sprites-icons .on .edit1, .site-liberation .cat-monlibe .bg-sprites-icons a:hover .edit1 {
    background-position: -128px -101px
}

.site-liberation .bg-sprites-icons .heart1, .site-liberation .bg-sprites-icons .heart1-laune, .site-liberation .bg-sprites-icons .heart1-black {
    width: 12px;
    height: 12px
}
...
.site-liberation .cat-laune .bg-sprites-icons .on .heart1, .site-liberation .cat-laune .bg-sprites-icons a:hover .heart1 {
    background-position: -82px -84px
}
...
.site-liberation .toolbox .txt-min, .site-liberation .toolbox .txt-plus, .site-liberation .toolbox .txt-reset, .site-liberation .toolbox .comment, .site-liberation .toolbox .facebook, .site-liberation .toolbox .twitter {
    color: #818181
}

.site-liberation .toolbox .txt-min:hover, .site-liberation .toolbox .txt-plus:hover, .site-liberation .toolbox .txt-reset:hover, .site-liberation .toolbox .comment:hover {
    color: #000
}
...
.site-liberation .toolbox li a.facebook:hover, .site-liberation .toolbox li a.twitter:hover {
    background-color: #818181;
    color: #F7F7F7
}

.site-liberation .toolbox li.btn-comment, .site-liberation .toolbox li.abo-1-euro {
    background: #f8f8f8
}
...
.site-liberation .toolbox li.fold-options, .site-liberation .toolbox li.fold-options ul {
    background: #f8f8f8
}

.site-liberation .toolbox li.fold-options+li.fold-options, .site-liberation .toolbox li.fold-options ul {
    border-color: #d7d7d7
}
...
#bar-liberation, #bar-liberation a {
    color: #3c3c3c
}
...
#core-liberation .block-activities .block-content ul li, #core-liberation .block-activities .block-content ul li a, #bar-liberation .content ul.list li, #bar-liberation .content ul.list li a {
    color: #222
}

#core-liberation .block-activities .block-content ul li span, #bar-liberation .content ul.list li span {
    color: #878787
}
...
#bar-liberation #personal-options-content ul.subscription strong, #bar-liberation #personal-options-content ul.subscription li.subscribe, #bar-liberation #personal-options-content ul.subscription li.subscribe a {
    color: #a40000
}
...
#bar-liberation #personal-options-content ul li a, #bar-liberation #personal-options-content ul li strong {
    color: #3c3c3c
}
...
#page-paywall .content .arguments .arg h4, #page-paywall .content .arguments .arg .price {
    color: #222
}
...
.autopromo-7days .btn-laune, .autopromo-7days .btn-zoneabo {
    float: right;
    width: 90px;
...
.site-liberation .block-partnership .block-content .autopromo-7days .hp p, .site-liberation .block-promo .block-content .autopromo-7days .hp p {
    margin: 0;
...
.autopromo-libe1euro .btn-laune, .autopromo-libe1euro .btn-zoneabo {
    float: right;
    width: 90px;
    margin: 5px 5px 5px 10px;
    text-align: center
...
.site-liberation .block-partnership .autopromo-libe1euro .hp p, .site-liberation .block-promo .autopromo-libe1euro .hp p {
    margin: 0;
    padding: 3px 0 3px 6px;
    font-size: 10px
}
...
.site-liberation .autopromo-35unit h2, .site-liberation .autopromo-35unit p {
    display: inline-block;
    font-family: Georgia, "Times New Roman", Times, serif;
    margin-left: 28px
}
